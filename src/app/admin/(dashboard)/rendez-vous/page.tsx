  ...
  return (
    <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <Link href="/admin/rendez-vous/en-attente" className="rounded-full border border-slate-300 px-4 py-2 text-sm font-medium">
          Voir les rendez-vous en attente
        </Link>
        <Link href="/admin/rendez-vous/agenda" className="rounded-full border border-slate-300 px-4 py-2 text-sm font-medium">
          Voir l'agenda confirme
        </Link>
        <Link href="/admin/rendez-vous/nouveau" className="rounded-full bg-slate-950 px-4 py-2 text-sm font-semibold text-white">
