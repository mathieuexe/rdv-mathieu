          ...
          <section className="rounded-lg border border-slate-200 bg-white shadow-sm">
            ...
            <div className="p-4 md:p-6">
              <form className="flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-all hover:bg-blue-700 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(48,128,238,0.25)]"
                >
